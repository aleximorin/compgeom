...
_quadratic_triangle_gaussian_quadrature = {1: (np.array([[1. / 6, 1. / 6],  # gauss points
                                                         [2. / 3, 1. / 6],
                                                         [1. / 6, 2. / 3]]),
...
# SEGMENTS
_linear_segment_gaussian_quadrature = {1: (0, 2),
                                       2: (np.array(
                                           [-1. / np.sqrt(3),
                                            -1. / np.sqrt(3)]),
                                           np.array([1, 1]))}
...
_segment_gaussian_quadrature = {'linear': _linear_segment_gaussian_quadrature,
